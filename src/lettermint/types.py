...
MessageEventType: TypeAlias = Literal['queued', 'processed', 'suppressed', 'delivered', 'auto_replied', 'soft_bounced', 'hard_bounced', 'spam_complaint', 'failed', 'blocked', 'policy_rejected', 'unsubscribed', 'opened', 'clicked', 'inbound_received', 'inbound_queued', 'inbound_spam_blocked', 'inbound_processed', 'inbound_retry']
